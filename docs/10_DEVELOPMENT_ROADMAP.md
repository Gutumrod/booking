...
**2026-09-22 R4 current state:** canonical source is `feature/bk01-real-shop-hardening-r4 @ 3b3a3338de029a058aa5763c806be42f8a5205ca`. Independent Codex R9 verdict is `SOURCE_REVIEW_PASS / BROWSER_PROOF_RESUME`; tests 118/118, lint 0 errors / 12 warnings, Admin + Consumer builds and typechecks PASS. Real KMO browser/runtime proof closed NEW-F18 Services/Staff, but R4 remains OPEN: `staff_schedules` and `shop_holidays` still need a controlled anon SELECT repair on predicate column `shop_id`, KMO has zero public staff so positive hold/create E2E needs an authorized fixture, and Admin browser/mobile acceptance remains owed. Current disposition: `BROWSER_PROOF_PARTIAL / KMO_RUNTIME_AND_FIXTURE_BLOCKED`. Do not retry Junction A, mutate shared LAB/runtime, start R7, formal Junction B, Order-live or Claim-live work before durable HOUSE-A PASS. See `docs/CURRENT_STATUS.md`, `docs/daily/2026-09-22.md`, and `docs/handoffs/HANDOFF-BK01-R4-EOD-2026-09-22.md`.
